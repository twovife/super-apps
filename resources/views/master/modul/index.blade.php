<x-app-layout>
    ...
    <x-body-area>
        <x-body-st>Existing Moduls</x-body-st>
        <x-body-content>
    ...
    <div id="formStore" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            <!-- Modal content -->
            <form action="{{ route('user.modul.store') }}" method="POST">
                @csrf
                @method('POST')
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            <div>
                                <x-label for="modul_name">Modul Name</x-label>
                                <x-input name="modul_name" id="modul_name" placeholder="Modulname Permission" required
                                    type="text"></x-input>
                            </div>
                        </div>
