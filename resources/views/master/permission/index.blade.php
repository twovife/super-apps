<x-app-layout>
    ...
    <x-body-area>
        <x-sub-title-flex :title="'Filters'">
            <x-button-action :btntype="'primary'" data-modal-toggle="formStore">
                <x-slot type="button" name="icons">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            ...
                            <div>
                                <x-label for="master_modul_id">Modul Name</x-label>
                                <x-select name="master_modul_id" id="master_modul_id" placeholder="Select Modul Name"
                                    required>
                                    @foreach ($mastermoduls as $mastermodul)
                                        <option value="{{ $mastermodul->id }}">{{ $mastermodul->modul_name }}</option>
                                    @endforeach
                                </x-select>
                            </div>
                        </div>
